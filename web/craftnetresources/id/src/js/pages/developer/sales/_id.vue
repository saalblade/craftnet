<template>
    <div v-if="sale">
        <p><router-link class="nav-link" to="/developer/sales" exact>← Sales</router-link></p>
        <h1>#SAL000{{sale.id}}</h1>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters({
                getSaleById: 'developers/getSaleById',
            }),

            sale() {
                return this.getSaleById(this.$route.params.id);
            }
