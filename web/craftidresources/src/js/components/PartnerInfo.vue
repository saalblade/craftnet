        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div v-else>
                    ...
                    <textarea-field id="shortBio" label="Short Bio" instructions="Max 255 characters. Shown on your listing card." v-model="draft.shortBio" :max="255" :errors="errors.shortBio" />
