	...
	<div>
		<div class="form-group">
			...
			<draggable v-model="pluginDraft.categoryIds">
				<div class="alert float-left clearfix mb-3" v-for="category in selectedCategories">
					<div class="flex">
						<div>{{category.title}}</div>
						<div class="ml-3 mt-1">
							<a class="" href="#" @click.prevent="unselectCategory(category.id)"><i class="fa fa-remove text-red"></i></a>
						</div>
					</div>
				</div>
			</draggable>
