...
class ConnectController extends BaseController
{
    ...
    public function init()
    {
        ...
        {
            $token = $this->getAuthTokenByUserId(Craft::$app->getUser()->getIdentity()-id);
...
*/
    ...
    public function actionValidate(): Response
    {
        ...
        $existingToken = $this->getAuthTokenByUserId($currentUser->id);
...
*/
    ...
    {
        $currentUser = Craft::$app->getUser()->getIdentity();
        $token = $this->getAuthTokenByUserId($currentUser->id);
...
*/
     ...
     */
  /*
    private function _getProvider(): Github
    {
        return new Github([
